...
class InnovationObject(Base):
    ...
    innovation_links = relationship(
        "InnovationLink",
        foreign_keys="InnovationLink.object_id",
        back_populates="innovation_object",
    )
...
class Innovation(Base):
    ...
    # Relationships
    innovation_links = relationship(
        "InnovationLink", foreign_keys="InnovationLink.innovation_id", back_populates="innovation"
    )
...
class InnovationLink(Base):
    ...
    relationship_type = Column(
        String, default="contributes_to"
    )  # e.g., 'enables', 'contributes_to', 'precedes'
...
class DatabaseManager:
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.engine = create_async_engine(db_url, echo=Config.DATABASE_ECHO, future=True)
    ...
    async def cleanup_old_signals(self, max_signals: int = None) -> int:
        ...
        async with await self.get_session() as session:
            ...
            oldest_stmt = (
                select(Signal.id).order_by(Signal.created_at.asc()).limit(signals_to_delete)
            )
    ...
    async def get_innovation_tree(self, object_id: str) -> dict:
        ...
        async with await self.get_session() as session:
            ...
            stmt = (
                ...
                .options(
                    selectinload(InnovationObject.innovation_links).selectinload(
                        InnovationLink.innovation
                    )
                )
            ...
            tree = {"object": obj.to_dict(), "innovations": []}
            ...
            try:
                ...
                inventors_data = [
                    ...
                    },
                    {
                        ...
                        "description": "Co-inventor of the transistor",
                        "birth_year": 1910,
                        "death_year": 1989,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "description": "Computer architecture pioneer",
                        "birth_year": 1903,
                        "death_year": 1957,
                    },
                    {
                ...
                innovations_data = [
                    {
                        "id": "telephone",
                        "name": "Telephone",
                        "description": "Device for voice communication over distance",
                        "year": 1876,
                    },
                    {
                        "id": "transistor",
                        "name": "Transistor",
                        "description": "Semiconductor device for amplifying and switching electronic signals",
                        "year": 1947,
                    },
                    {
                        "id": "computer",
                        "name": "Electronic Computer",
                        "description": "Programmable electronic device for processing data",
                        "year": 1943,
                    },
                    {
                        "id": "microprocessor",
                        "name": "Microprocessor",
                        "description": "Central processing unit on a single chip",
                        "year": 1971,
                    },
                    {
                        "id": "personal_computer",
                        "name": "Personal Computer",
                        "description": "Computer designed for individual use",
                        "year": 1975,
                    },
                    {
                        "id": "cellular_network",
                        "name": "Cellular Network",
                        "description": "Mobile phone network using cellular technology",
                        "year": 1973,
                    },
                ]
                ...
                objects_data = [
                    {
                        "id": "smartphone",
                        "name": "Smartphone",
                        "description": "Mobile phone with computer capabilities",
                        "category": "technology",
                    },
                    {
                        "id": "computer",
                    ...
                    },
                    {
                        "id": "telephone",
                        "name": "Telephone",
                        "description": "Device for voice communication",
                        "category": "technology",
                    },
                ]
                ...
                inventor_innovation_data = [
                    ...
                    {
                        "id": "shockley_transistor",
                        "inventor_id": "shockley",
                        "innovation_id": "transistor",
                        "role": "co-inventor",
                    },
                    {
                        "id": "bardeen_transistor",
                        "inventor_id": "bardeen",
                        "innovation_id": "transistor",
                        "role": "co-inventor",
                    },
                    {
                        "id": "brattain_transistor",
                        "inventor_id": "brattain",
                        "innovation_id": "transistor",
                        "role": "co-inventor",
                    },
                    {
                        ...
                        "role": "theoretical_founder",
                    },
                    {
                        "id": "vonneumann_computer",
                        "inventor_id": "vonneumann",
                        "innovation_id": "computer",
                        "role": "architect",
                    },
                    {
                        "id": "jobs_pc",
                        "inventor_id": "jobs",
                        "innovation_id": "personal_computer",
                        "role": "popularizer",
                    },
                    {
                        "id": "wozniak_pc",
